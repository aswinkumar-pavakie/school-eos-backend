// Writes one row per consequential action, and reads them back for audit-trail /
// login-activity screens. A thin wrapper over raw SQL, not an ORM entity -- consistent
// with the rest of this codebase (see infrastructure/postgres/postgres.service.ts).
