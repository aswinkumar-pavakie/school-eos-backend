...
export function toOffsetLimit(query: PageQuery): { offset: number; limit: number; page: number } {
...
export function toPageResult<T>(rows: T[], total: number, query: PageQuery): PageResult<T> {
