...
export class FacultyAcademicCoordinatorController {
  ...
  @Get('sections')
  async getSections(@CurrentActor() actor: AuthenticatedUser, @Query('gradeId') gradeId?: string) {
  ...
  async getOfferings(
    ...
    return { data: await this.service.getOfferings(actor.personId, { gradeId, sectionId }) };
  }
  ...
  async assignOfferingTeacher(
    ...
    return { data: await this.service.assignOfferingTeacher(actor.personId, id, dto) };
  }
  ...
  async assignClassAdvisor(
    ...
    return { data: await this.service.assignClassAdvisor(actor.personId, sectionId, dto) };
  }

  @Delete('sections/:sectionId/advisor')
  @HttpCode(HttpStatus.OK)
  async revokeClassAdvisor(@CurrentActor() actor: AuthenticatedUser, @Param('sectionId', ParseUUIDPipe) sectionId: string) {
  ...
  async getTimetable(@CurrentActor() actor: AuthenticatedUser, @Param('sectionId', ParseUUIDPipe) sectionId: string) {
    return { data: await this.service.getTimetable(actor.personId, sectionId) };
  }

  @Post('timetable/slots')
  async upsertTimetableSlot(@CurrentActor() actor: AuthenticatedUser, @Body() dto: UpsertTimetableSlotDto) {
    return { data: await this.service.upsertTimetableSlot(actor.personId, dto) };
  }

  @Delete('timetable/slots/:id')
  @HttpCode(HttpStatus.OK)
  async deleteTimetableSlot(@CurrentActor() actor: AuthenticatedUser, @Param('id', ParseUUIDPipe) id: string) {
    await this.service.deleteTimetableSlot(actor.personId, id);
    return { data: { deleted: true } };
  }

  @Post('timetable/:sectionId/publish')
  async publishTimetable(@CurrentActor() actor: AuthenticatedUser, @Param('sectionId', ParseUUIDPipe) sectionId: string) {
    return { data: await this.service.publishTimetable(actor.personId, sectionId) };
  }
  ...
  @Post('exams')
  async createExam(@CurrentActor() actor: AuthenticatedUser, @Body() dto: CreateCoordinatorExamDto) {
    return { data: await this.service.createExam(actor.personId, dto) };
  }

  @Post('exams/:id/advance')
  async advanceExamState(@CurrentActor() actor: AuthenticatedUser, @Param('id', ParseUUIDPipe) id: string) {
    return { data: await this.service.advanceExamState(actor.personId, id) };
  }

  @Get('exams/:id/subjects')
  async listExamSubjects(@CurrentActor() actor: AuthenticatedUser, @Param('id', ParseUUIDPipe) id: string) {
  ...
  async createExamSubject(
    ...
    return { data: await this.service.createExamSubject(actor.personId, id, dto) };
  }
  ...
  async getExamReadiness(@CurrentActor() actor: AuthenticatedUser, @Param('id', ParseUUIDPipe) id: string) {
  ...
  @Post('calendar')
  async createCalendarEvent(@CurrentActor() actor: AuthenticatedUser, @Body() dto: CreateCoordinatorCalendarEventDto) {
    return { data: await this.service.createCalendarEvent(actor.personId, dto) };
  }
  ...
  @Delete('calendar/:id')
  @HttpCode(HttpStatus.OK)
  async deleteCalendarEvent(@CurrentActor() actor: AuthenticatedUser, @Param('id', ParseUUIDPipe) id: string) {
