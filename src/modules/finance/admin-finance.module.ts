...
// are owned by the separate Finance/Accounts login (FinanceModule, same directory --
// renamed to AdminFinanceModule here purely to resolve a same-named-class merge
// collision between hot-fix-krishna and hot-fix-sri; nothing else changed). This
// Admin view only needs to read them.
