...
export const CONCESSION_TYPES = [
  'SIBLING', 'STAFF_WARD', 'SCHOLARSHIP', 'RTE', 'MERIT', 'HARDSHIP', 'GOVT_SCHEME', 'OTHER',
] as const;
...
export class CreateConcessionDto {
  ...
  @IsOptional()
  @Matches(/^(100|[0-9]{1,2})(\.[0-9]{1,2})?$/, { message: 'percent must be between 0 and 100 with up to 2 decimal places' })
  percent?: string;
